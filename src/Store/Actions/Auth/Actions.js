...
export const ChangePasswordFromSuperAdmin = (data) => async (dispatch) => {
  try {
    dispatch({
      type:CHANGE_PASSWORD_USER_CONSTANT.CHANGE_PASSWORD_USER_LOADING,
      payload: true,
    });
    ...
    if (res?.response_code === 200) {
      ...
      dispatch({
        type: CHANGE_PASSWORD_USER_CONSTANT.CHANGE_PASSWORD_USER_SUCESS,
        payload: res,
      });
      return true;
    } else {
