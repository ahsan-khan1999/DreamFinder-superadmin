...
const ViewDepoManager = ({ match, history }) => {
  ...
  const changeRoute =  (item) => {
    history.push('/app/menu/levels/EditDepoManager', item);
  };
  ...
  const handleAdd = () => {
    history.push('/app/menu/levels/CreateDepoManager');
  };
...
export default ViewDepoManager;
{
  /*  */
}
