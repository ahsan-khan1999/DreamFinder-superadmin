...
const ViewRsm = ({ match, history }) => {
  ...
  const changeRoute =  (item) => {
    history.push('/app/menu/levels/EditRsm', item);
  };
  ...
  const handleAdd = () => {
    history.push('/app/menu/levels/CreateRsm');
  };
      ...
      <CardBody>
        <Row>
          <Colxx xxs="12">
            ...
            <h4>View Regional Sales Manager</h4>
