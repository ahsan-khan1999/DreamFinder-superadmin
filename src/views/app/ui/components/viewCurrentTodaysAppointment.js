...
export default function viewCurrentTodaysAppointment(props) {
  const currentAppointment = props?.location?.state;
  const handleChangeToView = () => {
    props.history.push('/app/ui/components/todaysAppoinment');
  };
  ...
  return (
    <Card>
      <CardBody>
        ...
        <CardTitle>
          <IntlMessages id="View Today Appointment" />
        </CardTitle>
          ...
          <Form>
            <Row className="h-100">
              ...
              {/* <Col lg={6}>
                <FormGroup>
                  <Label>
                    <IntlMessages id="Doctor Name" />
                  </Label>
                  <span>
                    <p>{currentAppointment?.doctor_details?.name}</p>
                  </span>
                </FormGroup>
              </Col>
              <Col lg={6}>
                <FormGroup>
                  <Label>
                    <IntlMessages id="Patient Name" />
                  </Label>
                  <span>
                    <p>{currentAppointment?.patient_details?.name}</p>
                  </span>
                </FormGroup>
              </Col> */}
              <Col lg={6}>
